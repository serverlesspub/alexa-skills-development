...
* [Client-side upload](http://docs.aws.amazon.com/AmazonS3/latest/API/sigv4-post-example.html)

### Using Dynamo

* [DocumentClient](http://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/DynamoDB/DocumentClient.html)